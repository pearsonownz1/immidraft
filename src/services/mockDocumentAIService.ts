 ...
 * @param documentBytes Base64 encoded document content
 * @param mimeType MIME type of the document
 * @returns Extracted text from the document
 */
export async function mockExtractTextWithDocumentAI(documentBytes: string, mimeType: string): Promise<string> {
 ...
 */
export async function mockGenerateSummaryWithOpenAI(text: string): Promise<string> {
 ...
 * @param text Text to generate tags for
 * @returns Array of tags
 */
export async function mockGenerateTagsWithOpenAI(text: string): Promise<string[]> {
 ...
 * @param documentBytes Base64 encoded document content
 * @param mimeType MIME type of the document
 * @returns Object containing extracted text, summary, and tags
 */
export async function mockProcessDocument(documentBytes: string, mimeType: string): Promise<{
