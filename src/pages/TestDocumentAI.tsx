...
import { CriteriaDocumentUploaderWithMockAI } from '@/components/CriteriaDocumentUploaderWithMockAI';
    ...
    <div className="container mx-auto py-8">
      ...
      <div className="mt-8 bg-gray-50 p-6 rounded-lg border">
        ...
        <ul className="list-disc list-inside space-y-2 mb-4">
          <li><strong>mockDocumentAIService</strong>: Mock implementation of Google Cloud Document AI</li>
          <li><strong>mockDocumentProcessingServiceWithAI</strong>: Mock service for processing documents</li>
          <li><strong>CriteriaDocumentUploaderWithMockAI</strong>: UI component for uploading and displaying documents</li>
        </ul>
        <p className="mb-4">
